...
export default function CategoryDetailSingle() {
  return (
    <a href='#' className='bg-white rounded-md shadow-md hover:bg-gray-100'>
      ...
      <div className="py-2 px-4">
        <h3 className="text-md font-semibold text-gray-800">Super Human</h3>
        <p className="text-sm text-gray-600 mt-1">Dave Asprey</p>
      ...
      <div className="p-3 bg-gray-100 flex items-center justify-between text-gray-600 text-sm">
        ...
        <CiClock2 className='w-4 h-4'/>
          <span className="ml-1">24 min</span>
        </div>
        <div className="flex items-center">
          <svg
